use fresnel_2::endpoints::analysis::{intersection_visualization, map_overview, point_analysis};
...
async fn rocket() -> _ {
    ...
    rocket::build()
        ...
        .mount("/api/analysis", rocket::routes![point_analysis,map_overview,intersection_visualization])
}
